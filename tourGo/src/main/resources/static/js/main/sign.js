...
/** 
// 이용약관 동의
const checkAll = document.querySelector('.check_all input'); // 전체 동의 체크박스
const checkBoxes = document.querySelectorAll(".input_check input"); // 나머지 체크박스
const submitButton = document.querySelector(".next"); // 확인 버튼
const agreements = {
	checkbox1 : false,
	checkbox2 : false
};
